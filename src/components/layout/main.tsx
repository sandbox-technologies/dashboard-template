  ...
  return (
    <main
      ...
      className={cn(
        ...
        variant === 'glassmorphism' && [
          ...
          'before:backdrop-blur-xl before:rounded-3xl',
        ...
        variant === 'gradient' && [
          ...
          'before:animate-gradient-shift before:rounded-3xl',
          'before:blur-3xl',
          ...
          'after:animate-gradient-shift-reverse after:rounded-3xl',
          'after:blur-2xl',
        ],
        ...
        variant === 'particles' && [
          ...
          'before:rounded-3xl before:transition-opacity before:duration-300',
          'after:absolute after:inset-0 after:-z-10',
    ...
    >
      ...
      {(variant === 'glassmorphism' || variant === 'neon') && (
        <div
          className={cn(
            'absolute inset-0 -z-10 rounded-3xl opacity-[0.03] dark:opacity-[0.05]',
